			...
			<section id="pmpro_account-membership" class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_section', 'pmpro_account-membership' ) ); ?>">
				...
				<div class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_section_content' ) ); ?>">
					<?php if ( empty( $mylevels ) ) {
						...
						$url = site_url('memberships-info');
						?>
						<div id="pmpro_account-membership-none" class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_card' ) ); ?>">
							<div class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_card_content' ) ); ?>">
								<p><?php echo wp_kses( sprintf( __( "You are currently default member with access to Community, Tools & Calculator and Blogs section. To see plans & pricing <a href='%s'>Click Here Now.</a>", 'paid-memberships-pro' ), $url ), array( 'a' => array( 'href' => array() ) ) ); ?></p>
								<p>With upgrade you will get access to Market Research Portal.</p>
							</div> <!-- end pmpro_card_content -->
						</div> <!-- end pmpro_card -->
						<?php
					} else {
