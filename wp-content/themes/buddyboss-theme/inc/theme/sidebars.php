...
if ( !function_exists( 'buddyboss_widgets_init' ) ) {
	...
	function buddyboss_widgets_init() {
        ...
        if ( function_exists('is_bbpress') ) {
    		...
    		register_sidebar( array(
    			'name'			 => __( 'Forums → Listing', 'buddyboss-theme' ),
    			'id'			 => 'forums',
		...
		// singule form sidebar 
		register_sidebar( array(
			'name'			 => __( 'Forums → Single', 'buddyboss-theme' ),
			'id'			 => 'forum',
			'description'	 => __( 'Widgets in this area will be shown on Forum Discussions single pages.', 'buddyboss-theme' ),
			'before_widget'	 => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'	 => '</aside>',
			'before_title'	 => '<h2 class="widget-title">',
			'after_title'	 => '</h2>'
		) );		
		// single discussion topic page 	
		register_sidebar( array(
			'name'			 => __( 'Topics → Single', 'buddyboss-theme' ),
			'id'			 => 'topic',
			'description'	 => __( 'Widgets in this area will be shown on one discussion single pages.', 'buddyboss-theme' ),
			'before_widget'	 => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'	 => '</aside>',
			'before_title'	 => '<h2 class="widget-title">',
			'after_title'	 => '</h2>'
