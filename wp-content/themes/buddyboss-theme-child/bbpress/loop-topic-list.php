<li>
	...
	<div class="bs-item-wrap <?php echo esc_attr($class); ?>">
							...
							<span class="bbp-topic-freshness-author">
								...
								?>
									...
									if($topic_reply_count > 0){
										esc_html_e('replied', 'buddyboss-theme');
									}else{
										esc_html_e('posted', 'buddyboss-theme');
									}
		...
		<style>
			/* CSS */
			.button.fav.bp-secondary-action.bp-like-button.reaction {
			...
			.button.fav.bp-secondary-action.bp-like-button.reaction:hover {
